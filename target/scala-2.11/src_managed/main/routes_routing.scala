...
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ToDoController]).allToDoItems,
...
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ToDoController]).addToDoItem,
...
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ToDoController]).deleteToDoItem(fakeValue[Int]),
...
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ToDoController]).editToDoItem(fakeValue[Int]),
...
case controllers_ToDoController_allToDoItems1_route(params) => {
   call { 
        controllers_ToDoController_allToDoItems1_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ToDoController]).allToDoItems)
   }
}
...
case controllers_ToDoController_addToDoItem2_route(params) => {
   call { 
        controllers_ToDoController_addToDoItem2_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ToDoController]).addToDoItem)
   }
}
...
case controllers_ToDoController_deleteToDoItem3_route(params) => {
   call(params.fromPath[Int]("id", None)) { (id) =>
        controllers_ToDoController_deleteToDoItem3_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ToDoController]).deleteToDoItem(id))
   }
}
...
case controllers_ToDoController_editToDoItem4_route(params) => {
   call(params.fromPath[Int]("id", None)) { (id) =>
        controllers_ToDoController_editToDoItem4_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ToDoController]).editToDoItem(id))
   }
}
